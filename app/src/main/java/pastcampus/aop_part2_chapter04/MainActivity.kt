package pastcampus.aop_part2_chapter04
...
import pastcampus.aop_part2_chapter04.model.History
...
class MainActivity : AppCompatActivity() {
    ...
    fun historyButtonClicked(v: View) {
        ...
        // historyLinearLayout 아래의 모든 View 삭제
        historyLinearLayout.removeAllViews()


        Thread(Runnable {
            db.historyDao().getAll().reversed().forEach{
                runOnUiThread { // UI 작업은 mainTread 에서만 가능하기때문에 mainTread 호출
